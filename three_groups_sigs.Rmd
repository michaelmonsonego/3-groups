...
levels(CD3subset$Treatment) <- c('Saline',"αPD1-Il2")
...
for (name in signatures){
    ...
    CD3subset.sig[[name]] = (CD3subset.sig[[name]]-min(CD3subset.sig[[name]]))/
      (max(CD3subset.sig[[name]])-min(CD3subset.sig[[name]])) #M# what is this? why is it good?
}
...
source('D:/git_check/3-groups/signature_genes.rmd')

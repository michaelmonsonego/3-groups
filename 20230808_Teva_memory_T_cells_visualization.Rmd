...
setwd("//asafmadilabfs.tau.ac.il/asafmadilab$/Sarah/experiment/teva/memory/20221225 - memory - scRNA seq/R/3 groups/Figures/T cells")


T_cells = readRDS(file="//asafmadilabfs.tau.ac.il/asafmadilab$/Sarah/experiment/teva/memory/20221225 - memory - scRNA seq/R/3 groups/Objects/T cells/Teva_T_intermediate_object.rds")
...
ggsave(file = "features_T.png", dpi=300, width=12, height=12)
```
...
ggsave(file = "features_NKT.png", dpi=300, width=20, height=20)
```
...
ggsave(file = "features_NKT for teva.png", dpi=300, width=18, height=12)
```
...
ggsave(file = "features_gdT.png", dpi=300, width=20, height=20)
...
ggsave(file = "features_gdT T1.png", dpi=300, width=20, height=20)
            
FeaturePlot(T_cells, features = c("Cxcr6", "Ccr2", "Il18r1", "Il7r", "Cd44", "Il17f", "Ccr6", "Icos", "Il1r1"), order=TRUE,pt.size=1, reduction="tsne", ncol=3, label= TRUE)
ggsave(file = "features_gdT T17.png", dpi=300, width=20, height=20)
```
...
ggsave(file = "features_T_activation.png", dpi=300, width=30, height=40)
```
...
ggsave(file = "features_T_activation for teva.png", dpi=300, width=24, height=18)
```
...
ggsave(file = "features_T_effector.png", dpi=300, width=30, height=20)
```
Havcr2 = Tim3  
Tnfrsf4 = OX40  
Tnfrsf9 = 4-1BB  
...
ggsave(file = "features_T_effector for teva.png", dpi=300, width=24, height=12)
```
...
ggsave(file = "features_T_naive.png", dpi=300, width=20, height=20)
```
...
ggsave(file = "features_T_memory.png", dpi=300, width=30, height=20)
```
...
ggsave(file = "features_T_effector memory.png", dpi=300, width=30, height=40)
```
...
ggsave(file = "features_T_effector memory for teva.png", dpi=300, width=32, height=24)
```
...
ggsave(file = "features_T_central memory.png", dpi=300, width=30, height=50, limitsize=FALSE)
```
...
ggsave(file = "features_T_resident memory.png", dpi=300, width=40, height=60, limitsize=FALSE)
```

### g. B cells
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.width=24, fig.height= 24}
FeaturePlot(T_cells, features = c("Cd19", "Ms4a1", "Iglc1", "Ighm", "Igkc"), order=TRUE,pt.size=1, reduction="tsne", ncol=3, label= TRUE)
ggsave(file = "Features_T_B cells.png", dpi=300, width=30, height=20)
```
...
ggsave(file = "features_T_nature_early activated.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
...
ggsave(file = "features_T_nature_precursor exhausted.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
...
ggsave(file = "features_T_nature_exhausted.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
...
ggsave(file = "T_features_T_nature_naive-like.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_features_T_nature_effector memory.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
...
ggsave(file = "T_heatmap_activated effector.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_naive memory.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_effector memory.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_central memory.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_resident memory.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_nature_early activated.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_nature_precursor exhausted.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_nature_exhausted.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_nature_naive-like.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T_heatmap_nature_effector memory.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "T cells - annotated tsne - with names.png", dpi=300, width=25, height=20)

DimPlot(T_cells, reduction = "tsne", label=FALSE, pt.size=2)+
  theme(legend.text= element_text(size=24))
ggsave(file = "T cells - annotated tsne.png", dpi=300, width=25, height=20)
saveRDS(T_cells, file = "//asafmadilabfs.tau.ac.il/asafmadilab$/Sarah/experiment/teva/memory/20221225 - memory - scRNA seq/R/3 groups/Objects/T cells/T cells_object.rds")
...
ggsave(file = "T_stacked bar plot.png", dpi=300, width=10, height=10)
```
...
ggsave(file = "T_bar plot.png", dpi=300, width=15, height=10)
```
...
ggplot(proportions, aes(x=cluster, y=prop, fill=Treatment))+
  geom_bar(stat="identity",position=position_dodge())+
   scale_fill_manual(values= c("#CFBAE1", "#5C7D9D","#A4DEF9"))+
    ...
    theme(legend.title=element_text(size=18),legend.text= element_text(size=14), 
          axis.text.x=element_text(size=12,angle=45, hjust=1))
ggsave(file = "T_bar plot_proportions.png", dpi=300, width=15, height=10)       
```
...
ggsave(file = "features_T_Batf.png", dpi=300, width=10, height=10)
```
...
ggsave(file = "Vln_T_Batf.png", dpi=300, width=15, height=10)
```
...
ggsave(file = "features_T_glycolysis.png", dpi=300, width=30, height=30)
```
...
ggsave(file = "Vln_T_glycolysis.png", dpi=300, width=15, height=10)
```
...
ggsave(file = "dot_T_glycolysis.png", dpi=300, width=10, height=7)
```
...
ggsave(file = "signature_T_glycolysis.png", dpi=300, width=10, height=10)
```
...
ggsave(file = "feature_T_glycolysis_2.png", dpi=300, width=50, height=90, limitsize=FALSE)
```
...
ggsave(file = "signature_T_glycolysis2.png", dpi=300, width=10, height=10)
```
...
ggsave(file = "T_heatmap_glycolysis.png", dpi=300, width=20, height=30)
```
...
ggsave(file = "features_T_oxidative phosphorylation.png", dpi=300, width=90, height=90, limitsize=FALSE)
```
...
ggsave(file = "Vln_T_oxidative phosphorylation_1.png", dpi=300, width=20, height=30, limitsize=FALSE)
...
ggsave(file = "Vln_T_oxidative phosphorylation_2.png", dpi=300, width=20, height=30, limitsize=FALSE)
...
ggsave(file = "Vln_T_oxidative phosphorylation_3.png", dpi=300, width=20, height=30, limitsize=FALSE)
...
ggsave(file = "Vln_T_oxidative phosphorylation_4.png", dpi=300, width=20, height=30, limitsize=FALSE)
...
ggsave(file = "Vln_T_oxidative phosphorylation_5.png", dpi=300, width=20, height=30, limitsize=FALSE)
```
...
ggsave(file = "Vln_T_oxidative phosphorylation_6.png", dpi=300, width=20, height=25, limitsize=FALSE)            
```
...
ggsave(file = "dot_T_oxidative phosphorylation.png", dpi=300, width=15, height=19)
...
ggsave(file = "signature_T_oxidation.png", dpi=300, width=10, height=10)
```
